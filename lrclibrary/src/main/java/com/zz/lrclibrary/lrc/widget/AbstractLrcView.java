package com.zz.lrclibrary.lrc.widget;
...
import com.zz.lrclibrary.lrc.LyricsReader;
import com.zz.lrclibrary.lrc.model.LyricsInfo;
import com.zz.lrclibrary.lrc.model.LyricsLineInfo;
import com.zz.lrclibrary.lrc.utils.LyricsUtils;
...
public abstract class AbstractLrcView extends View {
    ...
    private void init(Context context) {
        ...
        //初始默认数据
        mLoadingText = "Room Id: %d";
        mLoadErrorText = "Room Id: %d";
        mNonsupportText = "Room Id: %d";
        mGotoSearchText = "Room Id: %d";
